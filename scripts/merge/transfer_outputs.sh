...
# The pw CLI mis-signs S3 keys that contain spaces (403 SignatureDoesNotMatch),
# and 3DCS names some result files with spaces (e.g. "CMRailTraining .hsu"),
# which aborts the whole Results upload. Strip spaces before uploading.
